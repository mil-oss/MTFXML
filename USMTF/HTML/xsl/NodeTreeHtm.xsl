...
<!--    <xsl:param name="tagName"/>
    ...
    <xsl:variable name="node" select="document($nodePath)//*[@name=$tagName]"/>-->
...
<!--Creates HTML Tree View of XML -->
    ...
    <xsl:template match="/">
        <div>
            <h4>
                <xsl:value-of select="//*:FudName[1]"/>
                <xsl:value-of select="//*:SetFormatName[1]"/>
                <xsl:value-of select="//*:MtfName[1]"/>
                <xsl:value-of select="//@FudName[1]"/>
                <xsl:value-of select="//@SetFormatName[1]"/>
                <xsl:value-of select="//@MtfName[1]"/>
            </h4>
