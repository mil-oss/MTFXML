...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="xsd:element[@name='TimeTo'][@type='field:TimeHourMinuteType']">
        <xsd:element name="TimeOnTargetHourMinute">
            <xsl:apply-templates select="@type" mode="copy"/>
            <xsl:apply-templates select="*" mode="copy"/>
        </xsd:element>
    ...
    <xsl:template match="xsd:element[@name='CountryOfTheWorld'][@type='field:GeopoliticalEntityType']">
        <xsd:element name="CountryOfTheWorld_4" type="GeopoliticalEntityType">
            <xsd:annotation>
                <xsd:appinfo>
                    <Field name="GeopoliticalEntities"
                        definition="A region controlled by a political community having an organized government and possessing internal and external sovereignty, most often as a State but sometimes having a dependent relationship on another political authority or a special sovereignty status."
                        version="B.1.02.00"/>
                </xsd:appinfo>
            </xsd:annotation>
        </xsd:element>
