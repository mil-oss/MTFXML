...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xsd" version="2.0">
    ...
    <xsl:variable name="OutDir" select="'../../../XSD/GoE_Schema/SeparateMessagesUnified/'"/>
    ...
    <xsl:template name="ExtractMessageSchemaUnified">
        ...
        <xsl:for-each select="$Msgs/xsd:schema/xsd:complexType[xsd:annotation/xsd:appinfo/*:Msg/@identifier = $msgident]">
            ...
            <xsl:result-document href="{$outdir}/{concat($mid,'.xsd')}">
                <xsd:schema xmlns="urn:mtf:mil:6040b:goe:mtf" xmlns:ism="urn:us:gov:ic:ism:v2" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xml:lang="en-US" targetNamespace="urn:mtf:mil:6040b:goe:mtf"
