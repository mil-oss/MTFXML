...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:appinfo="http://release.niem.gov/niem/appinfo/4.0/"
    ...
    <xsl:variable name="AttrNameChanges">
        <Change from="AlphabeticIdentifier" to="alphabeticID"/>
        <Change from="ColumnarIndicator" to="columnar"/>
        <Change from="ColumnHeader" to="columnName"/>
        <Change from="Justification" to="align"/>
        ...
        <Change from="GroupOfFieldsIndicator" to="fieldgroupseq"/>
