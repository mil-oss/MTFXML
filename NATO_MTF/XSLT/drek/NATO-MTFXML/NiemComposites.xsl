...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:mtfappinfo="urn:int:nato:ncdf:mtf:appinfo" exclude-result-prefixes="xsd" version="2.0">
    ...
    <xsl:template name="main">
        <xsl:result-document href="{$compositeoutputdoc}">
            <xsd:schema xmlns="urn:int:nato:ncdf:mtf:niem:composites" xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:ddms="http://metadata.dod.mil/mdr/ns/DDMS/2.0/" xmlns:f="urn:int:nato:ncdf:mtf:niem:fields" targetNamespace="urn:int:nato:ncdf:mtf:niem:composites"
