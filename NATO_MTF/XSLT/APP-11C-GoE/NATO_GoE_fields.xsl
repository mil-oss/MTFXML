...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="mtf_fields_xsd" select="document('../../XSD/APP-11C-ch1/Consolidated/fields.xsd')"/>
    <xsl:variable name="mtf_composites_xsd" select="document('../../XSD/APP-11C-ch1/Consolidated/composites.xsd')"/>
    ...
    <xsl:template match="/">
        <xsl:result-document href="../../XSD/APP-11C-GoE/natomtf_goe_fields.xsd">
            <xsd:schema xmlns="urn:int:nato:mtf:app-11(c):goe:fields"
                xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                targetNamespace="urn:int:nato:mtf:app-11(c):goe:fields"
                xml:lang="en-GB"
    ...
    <!-- type references are converted to local with SimpleType naming convention..-->
    ...
    <!-- base references are converted to local with SimpleType naming convention.-->
