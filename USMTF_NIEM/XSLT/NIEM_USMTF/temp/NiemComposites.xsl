...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:mtfappinfo="urn:mtf:mil:6040b:appinfo" exclude-result-prefixes="xsd" version="2.0">
    ...
    <xsl:variable name="fieldmap" select="document('../../XSD/NIEM_MTF_1_NS/NIEM_MTF_Fieldmaps.xml')"/>
    <xsl:variable name="comp_changes" select="document('../../XSD/Refactor_Changes_1_NS/CompositeChanges.xml')"/>

    <!--Output-->
    <xsl:variable name="compositeoutputdoc" select="'../../XSD/NIEM_MTF_1_NS/NIEM_MTF_Composites.xsd'"/>
    <xsl:variable name="compositemapoutputdoc" select="'../../XSD/NIEM_MTF_1_NS/NIEM_MTF_Compositemaps.xml'"/>
    ...
    <xsl:variable name="compositemaps">
        <xsl:for-each select="$composites_xsd/xsd:schema/xsd:complexType">
            ...
            <Composite mtfname="{@name}" niemcomplextype="{$niemcomplextype}" niemname="{$niemname}" niemelementname="{$niemelementname}" niemelementdoc="{$niemelementdoc}" mtfdoc="{$mtfdoc}"
