...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:variable name="fieldoutputdoc" select="'../../XSD/NIEM_MTF_1_NS/NIEM_MTF_Fields.xsd'"/>
    <xsl:variable name="fieldmapoutputdoc" select="'../../XSD/NIEM_MTF_1_NS/NIEM_MTF_Fieldmaps.xml'"/>
