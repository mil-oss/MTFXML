...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:term="http://release.niem.gov/niem/localTerminology/3.0/"
    xmlns:ism="urn:us:gov:ic:ism" xmlns:appinfo="http://release.niem.gov/niem/appinfo/4.0/" xmlns:ddms="http://metadata.dod.mil/mdr/ns/DDMS/2.0/"
    xmlns:inf="urn:mtf:mil:6040b:appinfo" exclude-result-prefixes="xs" version="2.0">
   ...
   accordance with provisions of DOD Directive 5230.25.</xsl:text>
            ...
            <Field niemelementname="{$niemelementname}" niemsimpletype="{$niemsimpletypename}" niemtype="{$niemcomplextype}" niemtypedoc="{$niemtypedoc}"
        ...
        <xsl:for-each select="$codelists/*">
            ...
            <xs:simpleType name="{@niemsimpletype}">
                <xs:annotation>
                    ...
                    <xs:appinfo>
                        <xsl:apply-templates select="info/*[1]" mode="cdeinfo"/>
                    </xs:appinfo>
                </xs:annotation>
    ...
    <xsl:template match="info/*" mode="cdeinfo">
        <xsl:copy>
