...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template match="xsd:simpleType" mode="maptype">
        ...
        <Field ncdfelementname="{$ncdfelementnamevar}" ncdfsimpletype="{$ncdfsimpletype}" ncdftype="{$ncdfcomplextype}" base="xsd:string" pattern="{$pattern}"
            ncdfpattern="{$ncdfpattern}" ncdfelementdoc="{$ncdfelementdoc}" ncdftypedoc="{$ncdftypedocvar}" mtftype="{@name}" mtfdoc="{$mtfdoc}" >
