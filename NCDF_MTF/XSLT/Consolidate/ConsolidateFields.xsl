...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" version="2.0">
    ...
    <xsl:template name="main">
        <xsl:result-document method="xml" href="{$ConsolidateFieldsPath}">
            <xs:schema targetNamespace="urn:int:nato:mtf:app-11(c):change01:elementals" xml:lang="en-GB" elementFormDefault="unqualified" attributeFormDefault="unqualified"
                xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns="urn:int:nato:mtf:app-11(c):change01:elementals">
