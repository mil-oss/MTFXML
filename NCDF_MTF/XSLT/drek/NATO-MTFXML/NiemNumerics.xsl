        ...
        <xsl:for-each select="$numerics_xsd/*">
            ...
            <xsl:choose>
                <xsl:when test="$base='xsd:integer'">
                    <Numeric mtfname="{@name}" niemsimpletype="{$niemsimpletype}" niemcomplextype="{$niemcomplextype}" niemelementname="{$niemelementname}" base="xsd:integer" min="{$min}"
                        max="{$max}" niemelementdoc="{$niemelementdoc}" mtfdoc="{$mtfdoc}" niemtypedoc="{$niemtypedoc}" ffirn="{$ffirn}" fud="{$fud}">
                        <appinfo>
                            <Field>
                ...
                <xsl:otherwise>
                    ...
                    <Numeric mtfname="{@name}" niemcomplextype="{$niemcomplextype}" niemsimpletype="{$niemsimpletype}" niemelementname="{$niemelementname}" base="xsd:decimal" min="{$min}" max="{$max}" fractionDigits="{$fractionDigits}"
                        totalDigits="{number($maxlen) - 1}" niemelementdoc="{$niemelementdoc}" mtfdoc="{$mtfdoc}" niemtypedoc="{$niemtypedoc}" ffirn="{$ffirn}" fud="{$fud}">
                        <appinfo>
                            <Field>
                                <xsl:for-each select="$appinfo/*/*:Field/@*">
                                    <xsl:copy-of select="."/>
