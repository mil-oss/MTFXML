   ...
   xmlns:appinfo="http://release.niem.gov/niem/appinfo/3.0/" xmlns:mtfappinfo="urn:int:nato:ncdf:mtf:appinfo" xmlns:ddms="http://metadata.dod.mil/mdr/ns/DDMS/2.0/"
    ...
    <xsl:template name="main">
        <xsl:result-document href="{$messagesxsdoutputdoc}">
            <xsd:schema xmlns="urn:int:nato:ncdf:mtf" xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:ddms="http://metadata.dod.mil/mdr/ns/DDMS/2.0/" xmlns:s="urn:int:nato:ncdf:mtf:niem:sets" xmlns:sg="urn:int:nato:ncdf:mtf:niem:segments" targetNamespace="urn:int:nato:ncdf:mtf:niem:messages"
                ...
                <xsd:import namespace="urn:int:nato:ncdf:mtf:niem:segments" schemaLocation="NIEM_MTF_Segments.xsd"/>
                <xsd:annotation>
                    <xsd:documentation>
